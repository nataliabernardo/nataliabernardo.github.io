...
The results were presented in an interactive viz ([click here]("/assets/viz/index.html")), where you can explore the ratings, topics by procedure and sentiment over time.
