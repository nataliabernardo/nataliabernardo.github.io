...
There's a trade-off between downtime and results, while some people prefer short recovery, others prefer drastic results. So if they could compare between treatments with similar goal (e.g. liposuction vs. Coolsculpting)
