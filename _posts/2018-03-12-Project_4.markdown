...
The results were presented in an interactive viz ([click here](https://nataliabernardo.github.io/blob/master/assets/viz/index.html)), where you can explore the ratings, topics by procedure and sentiment over time.
...
<iframe src="{{ site.url }}/assets/viz/index.html" width="1020" height="600" frameBorder="0.5"></iframe>
